    ...
    <nav class="navbar navbar-expand-md bg-body-tertiary" id="nav">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-md-0 nav-underline">
                    <li class="nav-item">
                                                            ...
                                                            <div class="row gy-3 gy-md-4 overflow-hidden">
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <input type="password" class="form-control"
                                                                        name="password" id="password" value="" required placeholder="example@123"
                                                                        autocomplete="on">
                                                                </div>
                                                                <!-- Submit button -->
                                                                <div class="col-12">
    ...
    <footer class="bg-dark py-5 container-fluid" id="footer">
        <div class="row row-gap-4">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <img src="./Assets/imgs/GFA Logo.png" alt="" class="img-fluid rounded-circle">
            </div>
