                            ...
                            <div class="form-group">
                                ...
                                <select name="class_id" id="class" class="form-select">
                                    ...
                                    foreach ($classes as $class) { ?>
                                        <option value="<?php echo $class->id ?>" <?php echo (isset($_GET['class_id']) && $_GET['class_id'] == $class->id ? 'selected':'' ) ?> ><?php echo $class->title ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group" id="section-container">
                                ...
                                <select name="section" id="Section" class="form-select">
                                    ...
                                    foreach ($sections as $section) { ?>
                                        <option value="<?php echo $section->id ?>" <?php echo (isset($_GET['class_id']) && $_GET['section'] == $section->id ? 'selected':'' ) ?> ><?php echo $section->title ?>
                                        </option>
                                    <?php } ?>
                                    ?>
                                </select>
